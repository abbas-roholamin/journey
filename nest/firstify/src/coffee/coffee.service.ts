...
export class CoffeeService {
  constructor(
    ...
    private readonly coffeeConfigOptions: ConfigType<typeof coffeeConfig>,
  ) {
    // const databaseHost = this.configService.get('coffee.foo');
    console.log(coffeeConfigOptions.foo);
  }
