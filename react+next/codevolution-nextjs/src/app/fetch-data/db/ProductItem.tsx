  ...
  return (
    <div>
      <div className="flex  p-4 gap-4">
        <Link href="/fetch-data/db/next-form" className="underline">
          New Product
        </Link>
        <Link href="/fetch-data/db/next-form?seed=true" className="underline">
          Seed
        </Link>
      </div>
      <ul className="space-y-4 p-4">
        {optimisticProducts.map((product) => (
          <li
            key={product.id}
            className=" bg-white text-black p-4 rounded  flex items-center justify-between"
          >
